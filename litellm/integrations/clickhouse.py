...
def _start_clickhouse():
    ...
    if clickhouse_host is not None:
        ...
        from litellm.enterprise.utils import _create_clickhouse_aggregate_tables
        from litellm.enterprise.utils import _create_clickhouse_material_views
...
class ClickhouseLogger:
    ...
    def log_event(
        ...
        # Disabling logging since it requires proxy util functions
        pass
